...
class SourcesControllerTest < ActionDispatch::IntegrationTest
  setup do
    ...
    @update = {
      isin: 'IT0000000000',
      name: 'A2a',
      url_1: 'https://www.borsaitaliana.it/companyprofile/htm/it/9.htm',
      name_1: 'Borsa Italiana',
      cod_1: 'borsaitaliana'
    }
  end
  ...
  test "should create source" do
    assert_difference('Source.count') do
      post sources_url, params: { source: @update }
    end
  ...
  test "should update source" do
    patch source_url(@source), params: { source: @update }
